...
- Community marketplace repository: <https://github.com/erlinerd/zcode-langfuse-plugin>
- Marketplace manifest: <https://raw.githubusercontent.com/erlinerd/zcode-langfuse-plugin/main/marketplace.json>
- Plugin manifest: <https://raw.githubusercontent.com/erlinerd/zcode-langfuse-plugin/main/.zcode-plugin/plugin.json>
- Latest plugin ZIP: <https://github.com/erlinerd/zcode-langfuse-plugin/releases/latest/download/plugin.zip>
- Latest ZIP checksum: <https://github.com/erlinerd/zcode-langfuse-plugin/releases/latest/download/plugin.zip.sha256>
- Release page: <https://github.com/erlinerd/zcode-langfuse-plugin/releases/latest>
...
The repository marketplace is named `zcode-langfuse-community`, and its
