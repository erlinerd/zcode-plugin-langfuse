...
- Generated output: `dist/`, structured as a ZCode marketplace tree
  (`marketplace.json` + `plugins/<name>/`) used for Releases, the official
  catalog, and local installs. Do not hand-edit or commit generated artifacts.
